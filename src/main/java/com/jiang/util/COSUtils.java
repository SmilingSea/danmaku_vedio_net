...
public class COSUtils {
    public static String UploadVideo(File file){
        ...
        try {
            ...
            // 换成您的 bucket
            config.put("bucket", "danmaku-vedio-network-1322480945");
            // 换成 bucket 所在地区
...
// 指定文件将要存放的存储桶
            String bucketName = "danmaku-vedio-network-1322480945";
// 指定文件上传到 COS 上的路径，即对象键。例如对象键为 folder/picture.jpg，则表示将文件 picture.jpg 上传到 folder 路径下
            long id = IdWorker.getId();
            String key = "video/"+ id +".mp4";

            PutObjectRequest putObjectRequest = new PutObjectRequest(bucketName, key,file);
            PutObjectResult putObjectResult = cosClient.putObject(putObjectRequest);
            return "https://danmaku-vedio-network-1322480945.cos.ap-nanjing.myqcloud.com/"+ key ;
        } catch (Exception e) {
            // TODO : 日志打印成文件
            e.printStackTrace();
